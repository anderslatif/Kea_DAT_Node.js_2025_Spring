...
// todo * Asynchronous code in Javascript.
a|
...
* link:00._Course_Material/00._Meta_Course_Material/plain_svelte_ssr/plain_svelte_ssr.md[Knows how to SSR Svelte from Express.]
// todo * Can work with promises and async/await. Understand why asynchronous code is relevant in Node.js.
a|
