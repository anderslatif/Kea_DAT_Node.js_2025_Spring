...
| 11. Fullstack / Promises
| Apr. 11th
a|
* Dotenv
* Client Routing link:https://www.npmjs.com/package/svelte-routing[Svelte Routing]
* Readable stores vs. link:00._Course_Material/01._Assignments/00._Meta_Course_Material/svelte_dotenv.md[Svelte DotEnv]
...
* link:00._Course_Material/01._Assignments/11._Fullstack_Promises[Knows how to SSR Svelte from Express.]
