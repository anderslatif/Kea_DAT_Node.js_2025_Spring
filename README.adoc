...
a|
link:00._Course_Material/01._Assignments/07._Server-side_Rendering_(SSR)_Routers/Svelte_interactive_tutorials_introduction_props.md[Svelte interactive tutorials  (introduction / props)]
...
* Undestands what XSS is and how to prevent it.
